...
function buildCandidateMovementData(days) {
...
export async function GET(request) {
  try {
    ...
    for (
      ...
      if (
        currentResidence?.latitude !=
          null &&
        currentResidence?.longitude !=
          null &&
        candidate
          .residence_latitude !=
          null &&
